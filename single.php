            ...
            <?php while ( have_posts() ) : the_post(); ?>
                <header class="mb-3">
                    ...
                    <div class="text-secondary velocity-post-info">
                        ...
                        <div class="px-3 d-inline-block"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="align-middle bi bi-calendar-check" viewBox="0 0 16 16"><path d="M10.854 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708 0"/><path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z"/></svg> 
                        <small class="align-middle"><?php echo velocity_post_date($post->ID);?></small></div>
                    </div>
                </header>
                ...
                <?php echo '<div class="row align-items-center">';
                    ...
                    echo '</div>';
                echo '</div>';
                echo '<hr class="border-top">';
                get_berita_iklan('iklan_single');
                 ?>
                <?php $cats = wp_get_post_terms( get_the_ID(), 'category' ); 
                    ...
                    echo '<h3 class="mt-4 velocity-title fs-5">Baca Juga</h3>';
